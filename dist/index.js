...
const useSlotCalendar = (initialDate = new Date(), onLoadingChange) => {
    ...
    const setCalendarData = react.useCallback((data) => {
        setState(prev => ({ ...prev, calendarData: data }));
    }, []);
    const navigateWeek = react.useCallback((direction) => {
        const days = direction === 'next' ? 7 : -7;
        const newDate = addDays(state.currentDate, days);
        setState(prev => ({ ...prev, currentDate: newDate }));
    }, [state.currentDate]);
    const loadSlots = react.useCallback(async (menuItemIds, staffId, isStaffSelected, shopId, reservationId) => {
        setLoading(true);
        setError(null);
        try {
    ...
    const navigateToPrevWeek = react.useCallback(() => {
        navigateWeek('prev');
    }, [navigateWeek]);
...
const SlotCalendar = ({ menuItemIds = [], staffId, isStaffSelected = false, shopId, reservationId, initialDate = new Date(), onSlotSelect, onLoadingChange, className = '', disabled = false }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: getCalendarClassName(), children: [jsxRuntime.jsx("div", { className: "slot-calendar__header", children: jsxRuntime.jsxs("div", { className: "slot-calendar__navigation", children: [jsxRuntime.jsxs("button", { id: "cal-prev-btn", className: "slot-calendar__nav-button", onClick: handlePrevWeek, disabled: disabled || isLoading || !calendarData?.hasPrev, children: [jsxRuntime.jsx("span", { className: "material-icons", children: "navigate_before" }), "\u524D\u306E\u9031"] }), jsxRuntime.jsxs("button", { id: "cal-next-btn", className: "slot-calendar__nav-button", onClick: handleNextWeek, disabled: disabled || isLoading || !calendarData?.hasNext, children: ["\u6B21\u306E\u9031", jsxRuntime.jsx("span", { className: "material-icons", children: "navigate_next" })] })] }) }), isLoading && (jsxRuntime.jsx("div", { className: "slot-calendar__progress", children: jsxRuntime.jsx("div", { className: "progress-bar" }) })), error && (jsxRuntime.jsxs("div", { className: "slot-calendar__error", children: ["\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F: ", error] })), jsxRuntime.jsx("div", { className: "slot-calendar__table-wrapper", children: jsxRuntime.jsx("table", { ref: tableRef, id: "cal-table", className: "slot-calendar__table", style: { opacity: isLoading ? 0.5 : 1 } }) })] }));
};
...
exports.SLOTS_STATUS = SLOTS_STATUS;
exports.SLOT_ARRAY_INDEX = SLOT_ARRAY_INDEX;
exports.SLOT_SYMBOLS = SLOT_SYMBOLS;
exports.SlotCalendar = SlotCalendar;
exports.WEEKDAYS_EN = WEEKDAYS_EN;
exports.WEEKDAYS_JP = WEEKDAYS_JP;
exports.addDays = addDays;
exports.addMinutes = addMinutes;
exports.createTimeSlotFromString = createTimeSlotFromString;
exports.formatDateTime = formatDateTime;
exports.formatTime = formatTime;
exports.startOfWeek = startOfWeek;
exports.useSlotCalendar = useSlotCalendar;
